...
from code_source.yt_dlp.extractor.youtube import YoutubeIE, YoutubePlaylistIE,YoutubeSearchURLIE,YoutubeMusicSearchURLIE
...
class VimeoRegexTest(unittest.TestCase):
    ...
    test_data = [
        ...
        ("https://youtu.be/dQw4w9WgXcQ",YoutubeIE._VALID_URL),
        ("https://www.youtube.com/live/dQw4w9WgXcQ",YoutubeIE._VALID_URL),
        ("https://www.youtube-nocookie.com/watch?v=dQw4w9WgXcQ",YoutubeIE._VALID_URL),
        ("https://www.deturl.com/www.youtube.com/watch?v=dQw4w9WgXcQ",YoutubeIE._VALID_URL),
        ("https://www.deturl.com/www.youtube.com/watch?v=dQw4w9WgXcQ/",YoutubeIE._VALID_URL),
        ("https://www.pwnyoutube.com/watch?v=dQw4w9WgXcQ",YoutubeIE._VALID_URL),

        ("https://www.invidio.us/playlist?list=PLVhZRy5c_nYhLrjji-jYZyKrNmOy8QvD-",YoutubePlaylistIE._VALID_URL),
        ("https://mychannel.youtube.com/playlist?list=PLvahj0XJXycFCQ-27Y6UYYv6JdK0hNZrB/",YoutubePlaylistIE._VALID_URL),
        ("https://www.youtube.com/playlist?list=PLvahj0XJXycFCQ-27Y6UYYv6JdK0hNZrB",YoutubePlaylistIE._VALID_URL),

        ("https://www.youtube.com/results?search_query=example",YoutubeSearchURLIE._VALID_URL),
        ("https://youtube.com/search?search_query=example&lang=en",YoutubeSearchURLIE._VALID_URL),
        ("https://www.youtube.com/results?search_query=example&lang=en/s",YoutubeSearchURLIE._VALID_URL),

        ("https://music.youtube.com/search?search_query=example&ytsession=bVn1nETu68jVrEzZcdjb7pWiBoNoGmta",YoutubeMusicSearchURLIE._VALID_URL),
        ("http://music.youtube.com/search?q=example",YoutubeMusicSearchURLIE._VALID_URL),
        ("https://music.youtube.com/search?search_query=example&ab_channel=exampleChannel",YoutubeMusicSearchURLIE._VALID_URL),
        ("http://music.youtube.com/search?q=example/",YoutubeMusicSearchURLIE._VALID_URL),
        ]
